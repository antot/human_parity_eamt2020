...
20180510 AT changes to make it work with Python3
- type=file -> type=argparse.FileType('r')
- print '' -> print('')
"""
...
PARSER = argparse.ArgumentParser(description="Build evaluation task input " \
  "file.")
PARSER.add_argument("source", type=argparse.FileType('r'), help="source language file")
PARSER.add_argument("reference", type=argparse.FileType('r'), nargs="?", help="reference language file")
PARSER.add_argument("system", metavar="system", nargs="+", type=argparse.FileType('r'),
